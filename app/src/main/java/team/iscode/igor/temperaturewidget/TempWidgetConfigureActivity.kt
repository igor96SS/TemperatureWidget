 ...
 */
class TempWidgetConfigureActivity : Activity() {
    private var appWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID
    private lateinit var appWidgetText: EditText
    private var onClickListener = View.OnClickListener {
        val context = this@TempWidgetConfigureActivity
    ...
    private lateinit var binding: TempWidgetConfigureBinding
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        binding = TempWidgetConfigureBinding.inflate(layoutInflater)
        ...
        appWidgetText.setText(loadTitlePref(this@TempWidgetConfigureActivity, appWidgetId))
    }
